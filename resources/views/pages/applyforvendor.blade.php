            ...
            <div class="center-1">
                ...
                <div class="page apply-vendor-page">
                    <div class="page-title">
                        <h1>Apply for vendor account</h1>
                    </div>
                    <div class="page-body">
                        <div class="topic-block">
                            <div class="topic-block-body">
                                <p>Put your apply vendor instructions here. You can edit this in the admin site.</p>
                            </div>
                        </div>


                        <form method="post" enctype="multipart/form-data" action="/vendor/apply">

                            <div class="fieldset">
                                <div class="form-fields">
                                    <div class="inputs">
                                        <label for="Name">Vendor name:</label>
                                        <input class="name" placeholder="Enter vendor name." type="text" data-val="true" data-val-required="Vendor name is required." id="Name" name="Name" value="" />
                                        <span class="required">*</span>
                                        <span class="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="inputs">
                                        <label for="Email">Email:</label>
                                        <input class="name" placeholder="Enter your email address." type="email" data-val="true" data-val-email="Wrong email" data-val-required="Email is required." id="Email" name="Email" value="moe@ex-corp.com" />
                                        <span class="required">*</span>
                            ...
                            <div class="buttons">
                                <input type="submit" id="apply-vendor" name="apply-vendor" class="button-1 apply-vendor-button" value="Submit" />
                            </div>
                            <input name="__RequestVerificationToken" type="hidden" value="CfDJ8KbjZjDJvz9Ire7PA-9PUq6BXQZIVxNrtsi8ATjGh8nqeMgwQZoiG5qfo560s2SEjzVlduMAopofVx1Vbyga9dCoZ1vl-xHN3JKkgcV2KZYDT693bk2eb0GPM-iwUVS5KKd2lzEnwHuhXYWFekb9INM" /></form>
