    ...
    <div class="master-wrapper-content">
        ...
        <div class="master-column-wrapper">
                    ...
                    <div class="listbox">
                        <ul class="list">
                            ...
                            <li class="customer-avatar">
                                <a href="avatar" class="active">Avatar</a>
                            </li>
            ...
            <div class="center-2">
                ...
                <form method="post" enctype="multipart/form-data" action="/customer/avatar">
                    <div class="page account-page avatar-page">
                        <div class="page-title">
                            <h1>My account - Avatar</h1>
                        </div>
                        <div class="page-body">
                            ...
                            <div class="buttons">
                                <input type="submit" name="upload-avatar" class="button-1 upload-avatar-button" value="Upload" />
                            </div>
                            <div class="info">
                                Avatar must be in GIF or JPEG format with the maximum size of 20 KB
                            </div>
                        </div>
                    </div>
                    <input name="__RequestVerificationToken" type="hidden" value="CfDJ8KbjZjDJvz9Ire7PA-9PUq6Su3JYSrBd6LODIpMJU5_P6pwsW6I_jDiangU7TltcUOVBi5zdpf5fTAA2XYPbQu4dtCd2rSTypFThiqZ35L_y6jDTXqF-nmgay6oW2pvmpAho6rPiuVsyD2KXZRkkaKQ" /></form>
