                    ...
                    <div class="listbox">
                        <ul class="list">
                            ...
                            <li class="change-password">
                                <a href="changepassword" class="active">Change password</a>
                            </li>
                ...
                <div class="page account-page change-password-page">
                    ...
                    <div class="page-body">
                        <form method="post" action="/customer/changepassword">
                            ...
                            <div class="fieldset">
                                <div class="form-fields">
                                    <div class="inputs">
                                        ...
                                        <input type="password" data-val="true" data-val-required="Old password is required." id="OldPassword" name="OldPassword" />
                                        <span class="required">*</span>
                                        <span class="field-validation-valid" data-valmsg-for="OldPassword" data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="inputs">
                                        <label for="NewPassword">New password:</label>
                                        <input type="password" data-val="true" data-val-length="The password should have at least 6 characters." data-val-length-max="999" data-val-length-min="6" data-val-required="New password is required." id="NewPassword" name="NewPassword" />
                                        <span class="required">*</span>
                                        <span class="field-validation-valid" data-valmsg-for="NewPassword" data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="inputs">
                                        <label for="ConfirmNewPassword">Confirm password:</label>
                                        <input type="password" data-val="true" data-val-equalto="The new password and confirmation password do not match." data-val-equalto-other="NewPassword" data-val-required="Password is required." id="ConfirmNewPassword" name="ConfirmNewPassword" />
                                        <span class="required">*</span>
                            ...
                            <div class="buttons">
                                <input type="submit" class="button-1 change-password-button" value="Change password" />
                            </div>
                            <input name="__RequestVerificationToken" type="hidden" value="CfDJ8KbjZjDJvz9Ire7PA-9PUq5-pkFps8kP1U8qTQB5WPESNLRoNlER9WfkwZX1DPq5h-ouftzvFQVO-qAcixVc7RRmk7kWw9BdBjvllcRXSnwJy_6GX40-Wqpad1IHNiDs_stSl2vKpinQ1uYe_82RnOE" /></form>
                    </div>
                </div>
