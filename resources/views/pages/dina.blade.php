<link href="{{asset("assets/css/real.css")}}" rel="stylesheet" type="text/css" xmlns="http://www.w3.org/1999/html"/>
...
<div class="video-slider-wrapper">
    <div id="video-player" class="video-player" data-id=""
        ...
        <img src="{{asset("assets/images/uploaded/0000504opt.jpeg")}}" alt="Cover photo"/>
        ...
        <div class="row">
            <div class="search-container home-page-filter-button">
                ...
                <select style="width: 150px !important;" placeholder="MANUFACTURER" id="manufacturer"
                    ...
                    @foreach(DB::table('product_specification_mapping')
                        ->select('product_specification_mapping.*')
                        ->get()
                        ->unique('manufacturer') as $manu)
                    ...
                    <div class="topic-block">
                        <div class="topic-block-body">
                            <div class="banner-bottom">
                                <ul>
                                    <li><a href="ken"><img
                                                src="{{asset("assets/images/uploaded/home_small_banner1opt.png")}}" alt=""
                                                width="445" height=""/></a></li>
                                    <li><a href="/"><img
                                                src="{{asset("assets/images/uploaded/home_small_banner2opt.png")}}" alt=""
                                                width="445" height=""/></a></li>
                                    <li><a href="/e-catalogue"><img
                                                src="{{asset("assets/images/uploaded/home_small_banner3opt.png")}}" alt=""
                                                width="445" height=""/></a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="picture">
                                        <a href="/brake-chambers-2" title="Show products in category BRAKE CHAMBERS">
                                            <img alt="Picture for category BRAKE CHAMBERS"
                                                 src="{{asset("assets/images/uploaded/0000821_brake-chambers_600-removebg-previewopt.png")}}"
                                        ...
                                        <a href="/triple-convoluted-air-springs"
                                           title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                            <img alt="Picture for category 3-IN-1 &amp; 4-IN-1 AIR/ELEC"
                                                 src="{{asset("assets/images/uploaded/0000820_3-in-1-4-in-1-airelec_600-removebg-preview.png")}}"
                                                 title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC"/>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="picture">
                                        <a href="/shock-mounting-accessories" title="Show products in category VALVES">
                                            <img alt="Picture for category VALVES"
                                                 src="{{asset("assets/images/uploaded/0000814_valves_600opt.png")}}"
                                    ...
                                    <div class="picture">
                                        <a href="/slack-adjusters-3" title="Show products in category SLACK ADJUSTERS">
                                            <img alt="Picture for category SLACK ADJUSTERS"
                                                 src="{{asset("assets/images/uploaded/0000818_slack-adjusters_600-removebg-previewopt.png")}}"
                                    ...
                                    <div class="picture">
                                        <a href="/brake-valves-2" title="Show products in category BRAKE VALVES">
                                            <img alt="Picture for category BRAKE VALVES"
                                                 src="{{asset("assets/images/uploaded/0000808_brake-valves_600-removebg-previewopt.png")}}"
                                        ...
                                        <a href="/dryer-cartridges-assemblies"
                                           title="Show products in category AIR DRYER KIT &amp; CARTRIDGES">
                                            <img alt="Picture for category AIR DRYER KIT &amp; CARTRIDGES"
                                                 src="{{asset("assets/images/uploaded/0000817_air-dryer-kit-cartridges_600-removebg-preview.png")}}"
                                                 title="Show products in category AIR DRYER KIT &amp; CARTRIDGES"/>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="picture">
                                        <a href="/drag-links" title="Show products in category DRAG LINKS">
                                            <img alt="Picture for category DRAG LINKS"
                                                 src="{{asset("assets/images/uploaded/0000822_drag-links_600-removebg-preview.png")}}"
                                    ...
                                    <div class="picture">
                                        <a href="/air-springs" title="Show products in category AIR SPRINGS">
                                            <img alt="Picture for category AIR SPRINGS"
                                                 src="{{asset("assets/images/uploaded/0000816_air-springs_600opt.png")}}"
                                        ...
                                        <a href="/camshaft-repair-kits-2"
                                           title="Show products in category CAMSHAFT &amp; REPAIR KITS">
                                            <img alt="Picture for category CAMSHAFT &amp; REPAIR KITS"
                                                 src="{{asset("assets/images/uploaded/0000819_camshaft-repair-kits_600-removebg-previewopt.png")}}"
                                                 title="Show products in category CAMSHAFT &amp; REPAIR KITS"/>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <a href="/drive-line"
                                           title="Show products in category HUB CAPS &amp; COMPONENTS">
                                            <img alt="Picture for category HUB CAPS &amp; COMPONENTS"
                                                 src="{{asset("assets/images/uploaded/0000810_hub-caps-components_600opt.png")}}"
                                                 title="Show products in category HUB CAPS &amp; COMPONENTS"/>
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <a href="/abs-sensors-components-2"
                                           title="Show products in category ABS SENSORS &amp; COMPONENTS">
                                            <img alt="Picture for category ABS SENSORS &amp; COMPONENTS"
                                                 src="{{asset("assets/images/uploaded/0000813_abs-sensors-components_600opt.png")}}"
                                                 title="Show products in category ABS SENSORS &amp; COMPONENTS"/>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="picture">
                                        <a href="/filters-4" title="Show products in category FILTERS">
                                            <img alt="Picture for category FILTERS"
                                                 src="{{asset("assets/images/uploaded/0000799_filters_600opt.png")}}"
                                    ...
                                    <div class="picture">
                                        <a href="/driveline-3" title="Show products in category DRIVELINE">
                                            <img alt="Picture for category DRIVELINE"
                                                 src="{{asset("assets/images/uploaded/0000815_driveline_600opt.png")}}"
                                        ...
                                        <div class="carousel-item">
                                            <div class="item-box">
                                                ...
                                                <div class="product-item" data-productid="113">
                                                    <div class="picture">
                                                        <a href="{{Route('productinfo',$product->id)}}" target="_blank">
                                                            title="Show details for TIE ROD END - LEFT HAND">
                                                            <img class="picture-img"
                                                                 src="{{asset("assets/images/uploaded/0000802_lx1900h-lube-spin-on-filter_360.jpeg")}}"
                                                    ...
                                                    <div class="details">
                                                        <h2 class="product-title">
                                                            <a href="{{Route('productinfo',$product->id)}}">{{$product->name}}</a>
                                                        </h2>
                            ...
                            <div class="blog-post">
                                <div class="post-primary">
                                    <a class="post-picture" href="/a-drivers-nice-friend">
                                        <img src="{{asset("assets/images/uploaded/0000630_590.jpeg")}}"
                            ...
                            <div class="blog-post">
                                <div class="post-primary">
                                    <a class="post-picture" href="/blog-1">
                                        <img src="{{asset("assets/images/uploaded/0000631_590.jpeg")}}"
...
<div class="home-page-footer-banners">
    ...
    <div class="slider-wrapper anywhere-sliders-nivo-slider theme- no-captions"
         ...
         data-imagesString="&lt;a href=&quot;/protective-gear&quot; title=&quot;&quot;&gt;&lt;img src=&quot;{{asset("assets/images/uploaded/0000642.jpeg")}}&quot; data-thumb=&quot;https://www.excohdparts.com/images/thumbs/0000642.jpeg&quot; alt=&quot;slider image&quot; /&gt;&lt;/a&gt;"
         data-effect="fade"
         data-slices="15"
         data-boxCols="8"
         data-boxRows="4"
        ...
        <a href="/protective-gear" title=""><img class="nivo-main-image"
                                                 src="{{asset("assets/images/uploaded/0000642.jpeg")}}"
                                                 alt="banner"/></a>
    ...
    <div class="slider-wrapper anywhere-sliders-nivo-slider theme- no-captions"
         ...
         data-imagesString="&lt;a href=&quot;/exhaust&quot; title=&quot;&quot;&gt;&lt;img src=&quot;{{asset("assets/images/uploaded/0000388.jpeg")}}&quot; data-thumb=&quot;https://www.excohdparts.com/images/thumbs/0000388.jpeg&quot; alt=&quot;slider image&quot; /&gt;&lt;/a&gt;"
        ...
        <a href="/exhaust" title=""><img class="nivo-main-image" src="{{asset("assets/images/uploaded/0000388.jpeg")}}"
                                         alt="banner"/></a>
        <div class="nivo-caption" style="display: block;"></div>
    </div>
    ...
    <div class="slider-wrapper anywhere-sliders-nivo-slider theme- no-captions"
         ...
         data-imagesString="&lt;a href=&quot;/slack-adjusters&quot; title=&quot;&quot;&gt;&lt;img src=&quot;{{asset("assets/images/uploaded/0000639.jpeg")}}&quot; data-thumb=&quot;https://www.excohdparts.com/images/thumbs/0000639.jpeg&quot; alt=&quot;slider image&quot; /&gt;&lt;/a&gt;"
         data-effect="fade"
         data-slices="15"
         data-boxCols="8"
         data-boxRows="4"
        ...
        <a href="/slack-adjusters" title=""><img class="nivo-main-image"
                                                 src="{{asset("assets/images/uploaded/0000639.jpeg")}}"
                                                 alt="banner"/></a>
        <div class="nivo-caption" style="display: block;"></div>
    </div>
</div>
