                        ...
                        ->get() as $category)
                            <div class="item-box">
                                ...
                                <div class="manufacturer-item">
                                    <h2 class="title">
                                        <a href="{{Route('maincategories',$category->id)}}" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                            {{$category->name}}
                                        </a>
                                    </h2>
                                    <div class="picture">
                                        <a href="{{Route('maincategories',$category->id)}}" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                            <img alt="Picture for category 3-IN-1 &amp; 4-IN-1 AIR/ELEC" src="{{asset("assets/images/uploaded/0000820_3-in-1-4-in-1-airelec_600-removebg-previewopt.png")}}" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="item-grid">
                            @foreach(DB::table('subcategory')
                                ...
                                <div class="item-box">
                                    <div class="manufacturer-item">
                                        <h2 class="title">
                                            <a href="{{Route('subcategory',$subcategory->id)}}" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                                {{$subcategory->name}}
                                            </a>
                                        </h2>
                                        <div class="picture">
