                    ...
                    <div class="listbox">
                        <ul class="list">
                            ...
                            <li class="reward-points">
                                <a href="rewardpoints" class="active">Reward points</a>
                            </li>
            ...
            <div class="center-2">
                ...
                <div class="page account-page reward-points-page">
                    <div class="page-title">
                        <h1>My account - Reward points</h1>
                    </div>
                    <div class="page-body">
                        <div class="reward-points-overview">
                            <div class="current-balance">Your current balance is 0 reward points (€0.00).</div>
                        </div>
