                        ...
                        <div class="sub-categories-wrapper">
                            ...
                            <div class="title">
                                ...
                                <div class="sub-cat-img-thumb">
                                    <a class="categorie-thumb" href="{{Route('finalcategory',$category->id)}}" title="Show products in category BRAKE CHAMBERS">
                            ...
                            @foreach(DB::table('categories')
                                ...
                                <ul class="list" >
                                    ...
                                    <ul class="sublist">
                                        ...
                                        <li class="inactive">
                                            <a href="{{Route('subcategory',$subproduct->id)}}" class="width-sublist">
                                                {{$subproduct->name}}
                                            </a>
                                            <div class="sublist-toggle-button"></div>
                                            @foreach(DB::table('thirdcategory')
