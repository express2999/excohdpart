...
<link href="<?php echo e(asset("assets/css/productinfo.css")); ?>" rel="stylesheet" type="text/css" />
<?php if(Auth::check()): ?>
...
<?php $__currentLoopData = $mydata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yourdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

    <meta name="description" content="<?php echo e($yourdata->metaDescription); ?>">
    <meta name="keywords" content="<?php echo e($yourdata->metaKeyword); ?>">
    ...
    <div class="master-wrapper-content">
                                        ...
                                        <div class="overview"  id="Product-information">
                                            ...
                                            <div class="additional-details">
                                                ...
                                                <div class="manufacturer-part-number tableView" >
                                                    ...
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->excoPartNo); ?></span>

                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Name</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->name); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Short Description</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->shortDescription); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Full Description</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->fullDescription); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">UPC Code:</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->upc); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">StockQuantity</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->stockQuantity); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Price</span>
                                                    <span class="value" id="mpn-112">$<?php echo e($yourdata->price); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Product Cost</span>
                                                    <span class="value" id="mpn-112">$<?php echo e($yourdata->productCost); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Weight</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->weight); ?> lb(s)</span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Length</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->length); ?></span>
                                                </div>
                                                <div class="manufacturer-part-number tableView" >
                                                    <span class="label">Width</span>
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->width); ?></span>
                                                </div>
                                                ...
                                                <div class="sku tableView " >
                                                    ...
                                                    <span class="value" id="mpn-112"><?php echo e($yourdata->height); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="manufacturers tableView">
                                                <?php $__currentLoopData = DB::table('product_category_mapping')
                                           ...
                                           ->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <span class="value">
                                            <a href="/filters-4"><?php echo e($product->category); ?></a>
                                             </span>
       ...
       <span class="warehouse-code">TX</span><span class="stock-qty" style="font-size: 14px;" >: In Stock</span>       </span>
                                            ...
                                            <div class="weight tableView">
                                                ...
                                                <span class="value">
                                    <?php echo e($yourdata->length); ?> x <?php echo e($yourdata->width); ?> x <?php echo e($yourdata->height); ?>
                                    ...
                                    <div id="quickTabs" class="productTabs "
                                        ...
                                        <div class="productTabs-body">
                                            ...
                                            <div id="quickTab-20">
                                                ...
                                                <?php $__currentLoopData = DB::table('specs')
                                          ->select('specs.*')
                                                ...
                                                <div class="custom-tab">
                                                    ...
                                                    <table border="0" width="561" cellspacing="0" cellpadding="0"><colgroup><col width="188" /> <col width="373" /> </colgroup>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="xl66" width="373"><?php echo e($product->type); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">excoBellows: </td>
                                                            <td class="xl67" width="373"><?php echo e($product->excoBellows); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl66" width="188" height="40">firestoneBellows:</td>
                                                            <td class="xl66" width="373"><?php echo e($product->firestoneBellows); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">goodyearBellows:</td>
                                                            <td class="xl67" width="373"><?php echo e($product->firestoneBellows); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl66" width="188" height="40">Contitech Bellows:</td>
                                                            <td class="xl66" width="373"><?php echo e($product->contitechBellows); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Triangle Bellows:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->triangleBellows); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Load (Lbs) @80  PSI:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->loadLBS80); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Load (Lbs) @100  PSI:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->loadLBS100); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Natural Freq. (CPM):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->natFrequency); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Design Height (In):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->designHeight); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Bottom Plate Type:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->bottomPlateType); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Top Plate Hole/Stud Qty:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->topPlateHole); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Top Plate Diameter (A):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->topPlateDiameter); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40"> Top Plate C to C Dia. (B):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->topPlateCtoC); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40"> Bottom Plate Hole/Stud Qty:</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->bottomPlateHole); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40"> Bottom Plate Diameter (C):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->bottomPlateDiameter); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40"> Bottom Plate C to C Dia. (D):</td>
                                                            <td class="xl67" width="373"> <?php echo e($product->bottomPlateCtoC); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Bumper: </td>
                                                            <td class="xl67" width="373"><?php echo e($product->bumper); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Bracket: </td>
                                                            <td class="xl67" width="373"> <?php echo e($product->bracket); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Min. Height: </td>
                                                            <td class="xl67" width="373"><?php echo e($product->minHeight); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Max. Height: </td>
                                                            <td class="xl67" width="373"> <?php echo e($product->maxHeight); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="xl67" width="188" height="40">Max. Diameter: </td>
                                                            <td class="xl67" width="373"> <?php echo e($product->maxDiameter); ?> </td>
                                                        </tr>
...
<script src="<?php echo e(asset("assets/js/productinfo.js")); ?>" type="text/javascript"></script>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/m/megoz1/excohdpart.rocketsweb.net/resources/views/pages/productinfo.blade.php ENDPATH**/ ?>