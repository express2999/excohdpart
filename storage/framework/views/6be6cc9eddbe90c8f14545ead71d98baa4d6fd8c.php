...
<head>
    ...
    <title>Admin - Exco-Hd-Part</title>
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <?php if($admin_logo_img == ''): ?>
                            <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="<?php echo e(asset('assets/images/uploaded/0000520.png')); ?>" alt="Logo Icon">
                        <?php else: ?>
...
<?php /**PATH /home/m/megoz1/excohdpart.rocketsweb.net/vendor/tcg/voyager/src/../resources/views/auth/master.blade.php ENDPATH**/ ?>