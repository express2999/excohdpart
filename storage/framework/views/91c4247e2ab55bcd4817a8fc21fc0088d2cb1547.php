    ...
    <div class="footer-upper">
        <div class="footer-block find-us">
            ...
            <ul class="list footer-collapse">
                <li class="address">
                    <span><a href="https://goo.gl/maps/sMFLrH5YABRZkKy79">1275 Bloomfield Ave , Fairfield , NJ 07004</a></span>
                </li>

                <li class="e-mail">
                    <span><a href="mailto:info@excofilter.com">info@excofilter.com</a></span>
                </li>
                <li class="mobile-phone">
                    <span> <a href="tel:973-227-5960">+1 (973) 227-5926</a></span>
                </li>
                <li class="phone">
                    <span><a href="tel:973-227-5926">+1 (973) 227-5926</a></span>
                </li>
            </ul>
        </div>
        <div class="footer-block information">
            ...
            <ul class="list footer-collapse">
                ...
                <li><a href="<?php echo e(Route('shippingandreturns')); ?>">Shipping &amp; returns</a></li>
                <li><a href="<?php echo e(Route('Privacynotice')); ?>">Privacy notice</a></li>
                <li><a href="<?php echo e(Route('conditionofuse')); ?>">Conditions of Use</a></li>
        ...
        <div class="footer-block my-account">
            ...
            <ul class="list footer-collapse">
                ...
                <li><a href="<?php echo e(Route('addresses')); ?>">Addresses</a></li>
                <li><a href="<?php echo e(Route('recentlyviewedproducts')); ?>">Recently viewed products</a></li>
                <li><a href="<?php echo e(Route('sitemap')); ?>">Sitemap</a></li>
                <li><a href="<?php echo e(Route('applyforvendor')); ?>">Apply for vendor account</a></li>
            </ul>
        </div>
                ...
                <div class="newsletter">
                    ...
                    <div class="newsletter-subscribe" id="newsletter-subscribe-block">
                        <div class="newsletter-email">
                            <input id="newsletter-email" class="newsletter-subscribe-text" placeholder="Enter your email ..." type="email" name="NewsletterEmail" value="" />
...
<?php /**PATH /home/m/megoz1/excohdpart.rocketsweb.net/resources/views/menus/footer/myfooter.blade.php ENDPATH**/ ?>