    ...
    <div class="master-column-wrapper">
        <div class="center-1">
            ...
            <div class="page-body">
                ...
                <div class="manufacturer-grid all-product">
                    <div class="item-grid">
                        ...
                        ->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item-box">
                                ...
                                <div class="manufacturer-item">
                                    <h2 class="title">
                                        <a href="<?php echo e(Route('maincategories',$category->id)); ?>" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                    ...
                                    <div class="picture">
                                        <a href="<?php echo e(Route('maincategories',$category->id)); ?>" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
                                            <img alt="Picture for category 3-IN-1 &amp; 4-IN-1 AIR/ELEC" src="<?php echo e(asset("assets/images/uploaded/0000820_3-in-1-4-in-1-airelec_600-removebg-previewopt.png")); ?>" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC" />
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="item-grid">
                            <?php $__currentLoopData = DB::table('subcategory')
                                ...
                                <div class="item-box">
                                    <div class="manufacturer-item">
                                        <h2 class="title">
                                            <a href="<?php echo e(Route('subcategory',$subcategory->id)); ?>" title="Show products in category 3-IN-1 &amp; 4-IN-1 AIR/ELEC">
...
<?php /**PATH /home/m/megoz1/excohdpart.rocketsweb.net/resources/views/pages/product.blade.php ENDPATH**/ ?>